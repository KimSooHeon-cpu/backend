...
public class ReservationServiceImpl implements ReservationService {
    ...
    // ======================================================================
    // [251027 신규] 특정 날짜에 '완료'된 예약 시간 목록 조회 (누락된 구현체 추가)
    // ======================================================================
    /**
    ...
    public List<ReservationResponse> listCompletedReservationsByDate(Long facilityId, String wantDateStr) {
    	...
    	// 요청 시간 조회 로그
        log.info("시설별 예약 시간 조회 요청: facilityId={}, wantDateStr={}", facilityId, wantDateStr);
        
        // 문자열 ("yyyy-MM-dd") -> LocalDate 변환
        DateTimeFormatter d  = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        LocalDate wantDate = LocalDate.parse(wantDateStr, d);
